 ...
 * the elements before performing the sort, after that, it will resuming the pipeline by sending the
 * sorted elements down the pipeline.
 *
 * If no comparator function is provided, then the sorting behavior is the same as that of `Array.prototype.sort`
