...
A super light-weight, tree-shakable, reusable, lazy pipeline TypeScript library with functional APIs and no 3rd-party
dependencies.

`lazy-pipeline` package is only
[2.6KB minified and 1KB gzipped+minified](https://bundlephobia.com/package/lazy-pipeline), but with its tree-shakable
